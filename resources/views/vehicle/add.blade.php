						...
						<form  action="{{ url('/vehicle/store') }}" method="post" enctype="multipart/form-data"  class="form-horizontal upperform">
							...
							<div class="form-group">
								...
								<div class="{{ $errors->has('price') ? ' has-error' : '' }}">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="price"  value="{{ old('price') }}" placeholder="{{ trans('app.Enter Price')}}" class="form-control" maxlength="10" >
										@if ($errors->has('price'))
							...
							<div class="form-group">
								...
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12 input-group date datepicker">
										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
										<input type="text"  name="dom" class="form-control" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;"  />
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="engineno"  value="{{ old('engineno') }}" placeholder="{{ trans('Enter Number Plate')}}" maxlength="30" class="form-control"required >
									</div>
								</div>
								<div class="">
							...
							<div class="form-group">
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="keyno"  value="{{ old('keyno') }}" placeholder="{{ trans('app.Key No')}}" maxlength="30" class="form-control" >
									</div>
								</div>
								<div class="">
