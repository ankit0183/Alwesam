...
<div class="right_col" role="main">
	...
	<div class="x_content">
        <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
			...
			{{-- <li role="presentation" class="active suppo_llng_li floattab"><a href="{!! url('/report/salesreport')!!}" class="anchor_tag "><span class="visible-xs"></span> <i class="fa fa-tty image_icon"> </i> <b>{{ trans('app.Vehicle Sales')}}</b> </a></li> --}}
            ...
            <div class="x_panel">
                <div class="x_content">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
                        <label class="control-label col-md-3 col-sm-5 col-xs-12 currency" for="date">{{ trans('app.Start Date')}} <label class="text-danger">*</label>
                        </label>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('end_date') ? ' has-error' : '' }}">
                        <label class="control-label col-md-3 col-sm-5 col-xs-12 currency" for="date">{{ trans('app.End Date')}} <label class="text-danger">*</label>
                        </label>
                        <div class="col-md-9 col-sm-7 col-xs-12 input-group date end_date">
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                          
						 <input type="text" name="end_date" id="end_date"  class="form-control" value="<?php if(!empty($e_date)) { echo date(getDateFormat(),strtotime($e_date));}else{ echo old('end_date'); }?>" placeholder="<?php echo getDatepicker();?>" required onkeypress="return false;" />
