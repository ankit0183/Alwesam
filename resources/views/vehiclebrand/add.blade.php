					...
					<div class="x_content">
						<div class="">
							<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
								<li role="presentation" class="floattab suppo_llng_li"><a href="{!! url('/vehiclebrand/list')!!}" class="anchr"><span class="visible-xs"></span> <i class="fa fa-list fa-lg">&nbsp;</i>{{ trans('app.VehicleBrand List')}}</a></li>
								<li role="presentation" class="active floattab suppo_llng_li_add"><a href="{!! url('/vehiclebrand/add')!!}" class="anchr"><span class="visible-xs"></span> <i class="fa fa-plus-circle fa-lg">&nbsp;</i><b>{{ trans('app.Add VehicleBrand')}}</b></a></li>
							</ul>
							<div class="clearfix"></div>
						</div>
						<div class="x_panel">
						<br />
							<form action="{{ url('/vehiclebrand/store') }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group col-md-12 col-sm-12 col-xs-12">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ trans('app.Vehicle Types')}} <label class="text-danger">*</label></label>
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12">
									...
									<div class="col-md-5 col-sm-5 col-xs-12">
									  <input type="text"  required="required" name="vehicalbrand" placeholder="{{ trans('app.Enter Vehicle Brand')}}" class="form-control col-md-7 col-xs-12" maxlength="30">
									</div>
								</div>
