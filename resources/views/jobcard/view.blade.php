               ...
               <div class="col-md-12 col-xs-12 col-xs-12">
                  ...
                  <div class="col-md-8 col-sm-12 col-xs-12 vehicle_space">
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
                        <label class="jobcardmargintop control-label col-md-2 col-sm-2 col-xs-12">{{ trans('Repair Suggestion')}}: </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <textarea name="customer_sug"  class="form-control" maxlength="100" required>{{ $job->customer_sug }}</textarea>
                        </div>
                        ...
                        <label class="text-danger">*</label></label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                        <textarea name="customer_comp" class="form-control" maxlength="9999" required>{{$job->customer_comp}}</textarea>
                        </div>
                     </div>
